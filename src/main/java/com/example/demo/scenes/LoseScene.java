...
/**
 * Represents the game over scene when the player loses.
...
public class LoseScene extends GameScene {
	...
	/** The path to the background image for the lose scene. */
	...
	/**
	 * Constructs a LoseScene with the specified screen dimensions.
	 * 
	...
	public LoseScene(double screenWidth, double screenHeight) {
		...
		// Change the background audio to the lose scene audio
		AudioManager.getInstance().changeBackgroundAudio(BackgroundAudioType.LOSESCENE);
	}

	/**
	 * Updates the scene. This method is not needed for the lose scene.
	 */
    @Override
    public void update() {
        // Not needed
